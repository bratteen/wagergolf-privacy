...
faq:
  - q: "Vad är skillnaden mot Foursome?"
    a: "I Foursome slår bara en av er ut. I Greensome slår båda ut och laget väljer det bästa utslaget. Sedan spelas hålet vartannat slag precis som i Foursome. Greensome är därför snällare, eftersom ni alltid har två chanser på driven."
...
Greensome är en mellanform mellan scramble och Foursome, och kanske den mest balanserade lagformen av alla. Båda i laget slår ut, vilket tar bort skräcken för ett ensamt dåligt utslag, men sedan delar ni boll och spelar vartannat slag som i Foursome. Det ger både trygghet och taktik.

## Så spelar du Greensome

- Båda i laget slår ut.
- Laget väljer det bästa av de två utslagen.
...
<figure class="guide-figure">
  <img src="{% shot "home" %}" alt="Wager Golf säsongssaldo och topplista" width="640" height="1306" loading="lazy">
