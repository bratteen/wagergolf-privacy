...
faq:
  ...
  - q: "Hva skjer hvis ingen gjør birdie?"
    a: "Da flyttes ingen penger. I pott-varianten betales innsatsene tilbake, ingen vinner og ingen taper."
  - q: "Finnes det en variant der hver birdie betales direkte?"
    a: "Ja. I stedet for en pott kan dere kjøre det slik at hver birdie gir betalt direkte: de andre spillerne betaler birdie-spilleren innsatsen hver, hver gang. Da kjennes hver birdie direkte i lommeboken."
  - q: "Hvor stor pleier innsatsen å være i en birdiepott?"
    a: "Det bestemmer dere selv. Vanlig er mellom 20 og 100 per spiller. Med fire spillere og 50 hver blir potten 200, så vinneren går pluss 150 etter fratrekk for egen innsats."
...
- Alle legger samme innsats i potten før runden.
- Hver birdie, altså ett slag under par på et hull, telles.
- En eagle eller bedre telles som én birdie, én per hull.
- Flest birdier når runden er slutt, tar potten. Likt antall deler potten.
- Gjør ingen birdie, betales innsatsene tilbake.
...
Si at dere er fire spillere og legger 50 hver i potten. Potten blir innsats ganger antall spillere, altså 50 × 4 = 200.

I løpet av runden gjør Anna tre birdier, Bea én, og de andre to ingen. Anna har flest og tar hele potten på 200. Siden hun selv la inn 50, blir nettogevinsten hennes 150. De tre andre taper innsatsen sin og ligger 50 i minus hver.

- Anna: +150 (potten 200 minus egen innsats 50)
- Bea: −50
- Spiller 3: −50
- Spiller 4: −50
