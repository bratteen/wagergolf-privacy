...
// elva handskrivna månadsarrayer vore elva tillfällen att stava fel.
//
...
function localDate(d, lang) {
  ...
  // svDate skrev ut "31 februari", alltså synligt fel. Med hundratals datumfält
  // över elva språk ska ett stavfel synas som stavfelet det är, inte tyst bli ett
